...
# The code is highly based on the libracy of SLaK (https://github.com/VITA-Group/SLaK)
...
from engine_feature import train_one_epoch, evaluate
from utils import NativeScalerWithGradNormCount as NativeScaler
from sparse_core import Masking, CosineDecay

import utils
import models.SLaK_feature
...
# --epochs 3 --model SLaK_tiny --drop_path 0.1 --batch_size 4 \
# --lr 4e-3 --update_freq 8 --model_ema true --model_ema_eval true \
# --data_path D:\A_luwenxin\DATAs\cloud\\test_swimcat --num_workers 0 \
# --kernel_size 51 49  --output_dir /output_slak/
# --Decom True --sparse --width_factor 1.3 -u 2000 --sparsity 0.4 --sparse_init snip  --prune_rate 0.5 --growth random --epochs 3 --model SLaK_tiny --drop_path 0.1 --batch_size 4 --lr 4e-3 --update_freq 8 --model_ema true --model_ema_eval true --data_path D:\A_luwenxin\DATAs\cloud\\test_swimcat --num_workers 0 --kernel_size 51 49  --output_dir /output_slak/
def get_args_parser():
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='D:\A_luwenxin\DATAs\cloud\\test_swimcat\\', type=str,
                        help='dataset path')
    parser.add_argument('--eval_data_path', default="D:\A_luwenxin\DATAs\cloud\\test_swimcat\\", type=str,
    ...
    parser.add_argument('--output_dir', default='./output_swimcat/',
    ...
    # large kernel
    parser.add_argument('--Decom', type=str2bool, default=True, help='Enabling kernel decomposition')
    ...
    parser.add_argument('-u', '--update-frequency', type=int, default=20, metavar='N', help='how many iterations to adapt weights')
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if data_loader_val is not None:
            ...
            if args.model_ema and args.model_ema_eval:
                test_stats_ema = evaluate(args,data_loader_val, model_ema.ema, device, use_amp=args.use_amp)
